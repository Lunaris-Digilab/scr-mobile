...
const translations: TranslationMap = {
  ...
  // Product Detail
  productTabDetails: { en: 'Details', de: 'Details', es: 'Detalles', tr: 'Detaylar' },
  productTabReviews: { en: 'Reviews', de: 'Bewertungen', es: 'Reseñas', tr: 'Yorumlar' },
  productTabIngredients: { en: 'Ingredients', de: 'Inhaltsstoffe', es: 'Ingredientes', tr: 'Icerik' },
  productBenefits: { en: 'Benefits', de: 'Vorteile', es: 'Beneficios', tr: 'Faydalari' },
  ...
  productBenefitOne: { en: 'Helps support a clear skin look', de: 'Unterstuetzt ein klares Hautbild', es: 'Ayuda a una piel de aspecto mas limpio', tr: 'Daha temiz bir cilt gorunumunu destekler' },
  productBenefitTwo: { en: 'Supports smoother texture and tone', de: 'Unterstuetzt eine glattere Textur und einen gleichmaessigen Ton', es: 'Favorece una textura y tono mas uniformes', tr: 'Doku ve ton gorunumunu iyilestirmeye yardim eder' },
  productBenefitThree: { en: 'Fits daily routine use', de: 'Passt zur taeglichen Anwendung', es: 'Encaja en el uso diario', tr: 'Gunluk rutin kullanimina uygundur' },
  productCleanserBenefitOne: { en: 'Removes dirt and excess oil gently', de: 'Entfernt Schmutz und ueberschuessiges Oel sanft', es: 'Elimina suciedad y exceso de grasa suavemente', tr: 'Kir ve fazla yagi nazikce temizler' },
  productCleanserBenefitTwo: { en: 'Helps keep pores feeling fresh', de: 'Hilft, die Poren frisch zu halten', es: 'Ayuda a mantener los poros frescos', tr: 'Gozeneklerin ferah kalmasina yardim eder' },
  productCleanserBenefitThree: { en: 'Prepares skin for next steps', de: 'Bereitet die Haut auf die naechsten Schritte vor', es: 'Prepara la piel para los siguientes pasos', tr: 'Cildi sonraki adimlara hazirlar' },
  productSerumBenefitOne: { en: 'Targets uneven tone appearance', de: 'Wirkt gegen ungleichmaessigen Hautton', es: 'Ayuda con el tono desigual', tr: 'Esit olmayan ton gorunumunu hedefler' },
  productSerumBenefitTwo: { en: 'Supports brighter looking skin', de: 'Unterstuetzt strahlender aussehende Haut', es: 'Favorece una piel de aspecto mas luminoso', tr: 'Daha aydinlik bir cilt gorunumunu destekler' },
  productSerumBenefitThree: { en: 'Helps improve skin smoothness', de: 'Hilft, die Hautglaette zu verbessern', es: 'Ayuda a mejorar la suavidad de la piel', tr: 'Cilt puruzsuzlugunu iyilestirmeye yardim eder' },
  productMoisturizerBenefitOne: { en: 'Boosts hydration and comfort', de: 'Erhoeht Feuchtigkeit und Komfort', es: 'Aumenta hidratacion y confort', tr: 'Nem ve cilt konforunu artirir' },
  productMoisturizerBenefitTwo: { en: 'Supports skin barrier feel', de: 'Unterstuetzt das Hautbarriere-Gefuehl', es: 'Apoya la sensacion de barrera cutanea', tr: 'Cilt bariyeri hissini destekler' },
  productMoisturizerBenefitThree: { en: 'Leaves skin softer all day', de: 'Laesst die Haut den ganzen Tag weicher wirken', es: 'Deja la piel mas suave durante el dia', tr: 'Cildi gun boyu daha yumusak hissettirir' },
  productSunscreenBenefitOne: { en: 'Helps protect from UV impact', de: 'Hilft vor UV-Einwirkung zu schuetzen', es: 'Ayuda a proteger del impacto UV', tr: 'UV etkilerine karsi korumaya yardim eder' },
  productSunscreenBenefitTwo: { en: 'Supports even looking tone', de: 'Unterstuetzt einen gleichmaessigen Teint', es: 'Favorece un tono de aspecto uniforme', tr: 'Esit ton gorunumunu destekler' },
  productSunscreenBenefitThree: { en: 'Ideal for daily daytime routine', de: 'Ideal fuer die taegliche Tagesroutine', es: 'Ideal para la rutina diaria de dia', tr: 'Gunluk gunduz rutini icin idealdir' },
  ...
  reminderSubtitle: { en: 'Set daily reminders for your morning and evening routines.', de: 'Legen Sie tägliche Erinnerungen für Ihre Morgen- und Abendroutine fest.', es: 'Establece recordatorios diarios para tus rutinas de mañana y noche.', tr: 'Sabah ve akşam rutinleriniz için günlük hatırlatma ayarlayın.' },
  reminderMorningTitle: { en: 'Morning Routine', de: 'Morgenroutine', es: 'Rutina matutina', tr: 'Sabah Rutini' },
  reminderMorningBody: { en: 'Time to start your morning skincare routine!', de: 'Zeit für Ihre Morgen-Hautpflege!', es: '¡Hora de empezar tu rutina matutina!', tr: 'Sabah cilt bakım rutinine başlama zamanı!' },
  reminderEveningTitle: { en: 'Evening Routine', de: 'Abendroutine', es: 'Rutina nocturna', tr: 'Akşam Rutini' },
  reminderEveningBody: { en: 'Time to start your evening skincare routine!', de: 'Zeit für Ihre Abend-Hautpflege!', es: '¡Hora de empezar tu rutina nocturna!', tr: 'Akşam cilt bakım rutinine başlama zamanı!' },
  reminderScheduledAt: { en: 'Reminder set for', de: 'Erinnerung gestellt auf', es: 'Recordatorio programado a las', tr: 'Hatırlatma saati:' },
  reminderSaveFailed: { en: 'Could not save reminder.', de: 'Erinnerung konnte nicht gespeichert werden.', es: 'No se pudo guardar el recordatorio.', tr: 'Hatırlatma kaydedilemedi.' },
  reminderPermissionTitle: { en: 'Permission needed', de: 'Berechtigung erforderlich', es: 'Permiso necesario', tr: 'İzin gerekli' },
  reminderPermissionMsg: { en: 'Please enable notifications in your device settings to receive reminders.', de: 'Bitte aktivieren Sie Benachrichtigungen in Ihren Geräteeinstellungen.', es: 'Habilite las notificaciones en la configuración de su dispositivo.', tr: 'Hatırlatma alabilmek için cihaz ayarlarından bildirimleri etkinleştirin.' },
